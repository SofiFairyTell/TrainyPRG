...
2. define нужна для определения констант используемых проектом в основном. 
...
В С аналогичная конструкция реализована через (getchar() != '\n'); . Но по сути это есть очистка символа новой строки. 